                                    ...
                                    if ($db->NumRows($query) > 0) {
                                        ...
                                        <ul>
                                            ...
                                            <?php while ($row = $db->FetchArray($query)) { ?>
                                                <li>
                                                    <div class="span4">
                                                        <p> <a class="fancybox" href="<?php echo ADDRESS_SLIDES . $row['file_name'] ?>"> <img class="img-polaroid" src="<?php echo ADDRESS_SLIDES . $row['file_name'] ?>" style="max-width:150px; "/></a> <span class=""> <a class="da-button red small" href="<?php echo ADDRESS_ADMIN_CONTROL ?>slides&action=edit&id=<?php echo $_GET['id'] ?>&slides_file_id=<?php echo $row['id'] ?>" style="color:#FFF; size:20px; text-decoration: none;" onclick="return confirm('Are you sure you want to delete?')" > ลบไฟล์ </a></span> </p>
                                                    </div>
                                                </li>
